...
trial_types = { ['Left_Odor_' num_str], ['Right_Odor_' num_str], ['Left_Air_' num_str], ['Right_Air_' num_str] };
...
for tt=1:2
    ...
    for side = 1:2
        ...
        subaxis(2,2,tt_air, 'Spacing', SPACING, 'Padding', PADDING, 'Margin', MARGIN);
